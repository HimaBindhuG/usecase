...
def signup_data(name,address,gender,dob,phone,email,password,posting,blood_group):
    query="INSERT INTO USER_CREDS "\
        "VALUES ("+"'"+str(name)+"'"+",'"+str(address)+"'"+",'"+str(gender)+"'"+",'"+date(dob)+"'"+",'"+int(phone)+"'"+",'"+str(email)+"'"+",'"+str(posting)+"'"+",'"+str(blood_group)+"'"+",'"+str(password)+"'"+")"
    print(query)
    return query
